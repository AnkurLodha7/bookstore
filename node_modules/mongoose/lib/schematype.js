 ...
 *
 * The error message argument is optional. If not passed, the [default generic error message views](#error_messages_MongooseError-messages) will be used.
 *
 * ####Examples:
 *
 ...
 *
 * From the examples above, you may have noticed that error messages support basic templating. There are a few other views keywords besides `{PATH}` and `{VALUE}` too. To find out more, details are available [here](#error_messages_MongooseError-messages)
 *
